          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image">
                <img class="mt-5" style="width: 100%" src="https://cdni.iconscout.com/illustration-pack/preview/forgot-password-98908.png?f=webp&w=420&modified_at=1636514255" alt="">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4" style="text-transform: uppercase; font-weight: bold;">Recover your password!</h1>
                  </div>

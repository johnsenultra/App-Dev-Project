      ...
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block bg-register-image">
            <img class="mt-5" src="https://i.pinimg.com/474x/3c/e8/1f/3ce81f802820c8415bfe04415a0bde3a.jpg" alt="">
          </div>
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4" style="text-transform: uppercase; font-weight: bold;">Create an Account!</h1>
              </div>
